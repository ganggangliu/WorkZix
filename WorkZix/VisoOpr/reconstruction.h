...
public:
  ...
  void setCalibration (FLOAT_M f,FLOAT_M cu,FLOAT_M cv);
...
private:
  ...
  result  updatePoint(const track &t,point3d &p,const FLOAT_M &step_size,const FLOAT_M &eps);
  ...
  FLOAT_M *J;                     // jacobian
  FLOAT_M *p_observe,*p_predict;  // observed and predicted 2d points
