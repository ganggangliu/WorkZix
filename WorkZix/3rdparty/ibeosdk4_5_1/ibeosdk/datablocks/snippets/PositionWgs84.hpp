...
public:
	void transformToTangentialPlane(const PositionWgs84& origin, double& pdX, double& pdY) const;
	void transformToTangentialPlane(const double originLattigudeInRad, const double originLongitudeInRad, double& pdX, double& pdY) const;

	static void transformToTangentialPlane(const double originsLatitudeInRad, const double originsLongitudeInRad,
	                                       const double pointsLatitudeInRad, const double pointsLongitudeInRad,
	                                       double& pointsX, double& pointsY);

	static void transformToTangentialPlane(const EcefPoint& originRefPointsEcef,
	                                       const double pointsLatitudeInRad, const double pointsLongitudeInRad,
	                                       double& pointsX, double& pointsY);

	static void transformFromTangentialPlane(const double originsLattigudeInRad, const double originsLongitudeInRad,
	                                         const double pointsX, const double pointsY,
	                                         double& pointsLatInRad, double& pointsLonInRad);

	void transformFromTangentialPlane(const double x, const double y, const PositionWgs84& origin);
	 ...
	 */
	void transformToTangentialPlaneWithHeading(const PositionWgs84& origin, double& x, double& y) const;
	 ...
	 */
	void transformFromTangentialPlaneWithHeading(const double x, const double y, const PositionWgs84& origin);
