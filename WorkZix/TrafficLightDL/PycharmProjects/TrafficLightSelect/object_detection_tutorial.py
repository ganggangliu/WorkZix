...
PATH_TO_CKPT = '/home/zix-kotei/PycharmProjects/TrafficLightSelect/traffic_light.pb'
#PATH_TO_CKPT = '/home/zix/zix/tensorflow-master/tensorflow/models/object_detection/xinzi.pb'

# List of the strings that is used to add correct label for each box.
#PATH_TO_LABELS = os.path.join('data', 'mscoco_label_map.pbtxt')
PATH_TO_LABELS = '/home/zix-kotei/zix/models/object_detection/data/traffic_light_label_map.pbtxt'
#PATH_TO_LABELS = '/home/zix/zix/tensorflow-master/tensorflow/models/object_detection/data/pet_label_map.pbtxt'
...
TEST_IMAGE_PATHS = []
#TEST_IMGAES_ROOT_PATH = '/home/zix/Documents'
#TEST_IMGAES_ROOT_PATH = '/home/zix/PycharmProjects/TrafficLightSelect/temp'
#TEST_IMGAES_ROOT_PATH = '/home/zix-kotei/PycharmProjects/TrafficLightSelect/demo_data/testsets/images'
TEST_IMGAES_ROOT_PATH = '/home/zix-kotei/PycharmProjects/TrafficLightSelect/demo_data/testsets/images/'
...
with detection_graph.as_default():
  with tf.Session(graph=detection_graph) as sess:
    for image_path in TEST_IMAGE_PATHS:
      ...
      image_ = image_.resize((im_width/2, im_height/2))
      time2 = time.time()
      print('Time cost2: ' + str(time2 - time1))
      # the array based representation of the image will be used later in order to prepare the
      # result image with boxes and labels on it.
      image_np_ = load_image_into_numpy_array(image_)
      time3 = time.time()
      print('Time cost3: ' + str(time3 - time2))
      # Expand dimensions since the model expects images to have shape: [1, None, None, 3]
      image_np_expanded_ = np.expand_dims(image_np_, axis=0)
      time4 = time.time()
      print('Time cost4: ' + str(time4 - time3))
      ...
      time5 = time.time()
      print('Time cost5: ' + str(time5 - time4))
      # Actual detection.
      ...
      time6 = time.time()
      print('Time cost6: ' + str(time6 - time5))
