...
def run_training():
    ...
    logs_val_dir = '/home/zix/PycharmProjects/A_vs_B/log_evaluate/'

    capacity = 10000
    num_class = 2
    train, train_label, val, val_label, capacity, num_class = input_train_val_split.get_files(train_dir, RATIO)
    ...
    logits = model.inference(train_batch, BATCH_SIZE, num_class)
