...
{
	bool ret =
		ibeosdk::fuzzyCompare(m_yawAngle, other.m_yawAngle)
		&& ibeosdk::fuzzyCompare(m_pitchAngle, other.m_pitchAngle)
		&& ibeosdk::fuzzyCompare(m_rollAngle, other.m_rollAngle)
		&& m_posX == other.m_posX
		&& m_posY == other.m_posY
		&& m_posZ == other.m_posZ
		;
