...
LanePtr Lane::create(const UINT8& id, const UINT64 laneId, const LaneType& type,
	CarriageWaySegmentPtr parent, const UINT8& nextLaneId, const UINT8& previousLaneId,
	const UINT8& leftLaneId, const UINT8& rightLaneId)
{
	return LanePtr(new Lane(id, laneId, type, parent, nextLaneId, previousLaneId,
...
Lane::Lane(CarriageWaySegmentPtr parent) : m_parent(parent)
{
	m_id = 0;
	m_laneId = 0;
