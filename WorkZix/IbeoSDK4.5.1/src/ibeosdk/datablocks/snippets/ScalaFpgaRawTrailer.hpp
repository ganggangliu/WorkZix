...
protected:
	...
	{
		switch (flagValue) {
		case false: m_configurationRegister = uint16_t(m_configurationRegister & ~bit); break;
		case true:  m_configurationRegister = uint16_t(m_configurationRegister | bit); break;
		} // switch
	}
