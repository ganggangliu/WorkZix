...
public:
	void getMicroseconds(const uint32_t newMicroseconds) { m_microseconds = newMicroseconds; }
	void getTimestamp(const NTPTime newTimestamp) { m_timestamp = newTimestamp; }
