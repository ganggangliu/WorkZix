...
protected:
	...
	//========================================
	/*!\brief Handle the reception of a command reply.
	 * \param[in] dh       Header that came along with that
	 ...
	 *///-------------------------------------
	virtual void onReceiveCommandReply(const IbeoDataHeader& dh, const char* bodyBuf) = 0;
...
protected:
	...
	//========================================
	/*!\brief Pointer to the thread that handles
	...
	//========================================
	/*!\brief Object used to exchange signals
	 *        between the main and the receive
	 *        thread.
	 *///-------------------------------------
